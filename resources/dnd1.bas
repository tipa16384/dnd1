...
00190 LET G=INT(RND(0)*24+2) 00200 LET H=INT(RND(0)*24+2) 
00210 FILE #1="DNG1" 
...
00690 INPUT Q3$ 00700 PRINT "NUMBER","ITEM","PRICE" 
00705 PRINT"-1-STOP" 
00710 FOR M=1 TO 15 
00720 READ I$(M),P(M) 
...
11110 GO TO 7000 
11120 END 
READY.VERSION 1.1 - DIGITALLY REMASTERED BY DEJAY CLAYTON 
 
PDP11-TELETYPE FONT (0)2014 DEJAY CLAYTON 
RELEASED INTO PUBLIC DOMAIN VIA THE 
...
VERSION HISTORY: 
---------------- 
VERSION 1.1 2014-04-17: ADDED NOTICES AND VERSION HISTORY 
 
VERSION 1.0 2014-04-17: INITIAL VERSION 